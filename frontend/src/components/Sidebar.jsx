...
const NAV_ITEMS = {
  ...
  president: [
    ...
    { label: 'Events',         icon: <EventOutlinedIcon />,               path: '/president/events' },
    { label: 'Announcements',  icon: <CampaignOutlinedIcon />,            path: '/president/announcements' },
    { label: 'Profile',        icon: <PersonOutlinedIcon />,              path: '/profile' },
  ],
  secretary: [
    ...
    { label: 'Events',         icon: <EventOutlinedIcon />,               path: '/secretary/events' },
    { label: 'Announcements',  icon: <CampaignOutlinedIcon />,            path: '/secretary/announcements' },
    { label: 'Profile',        icon: <PersonOutlinedIcon />,              path: '/profile' },
  ],
  member: [
