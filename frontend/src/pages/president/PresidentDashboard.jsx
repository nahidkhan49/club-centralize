    ...
    return (
      <Box sx={{ maxWidth: 600, mx: 'auto', mt: 4, p: 3 }}>
        <Alert severity="warning" sx={{ borderRadius: '14px' }}>
          You are logged in as a {isPresident ? 'President' : 'Secretary'} but you are not assigned to any club yet. Please contact the Platform Administrator to assign you to a club organization.
        </Alert>
      </Box>
    );
  }
  ...
  return (
    <Box sx={{ maxWidth: 1320, mx: 'auto', width: '100%', pb: 6 }}>
      ...
      <WelcomeBanner
        ...
        roleLabel={isPresident ? 'Club President' : 'Club Secretary'}
        action={
